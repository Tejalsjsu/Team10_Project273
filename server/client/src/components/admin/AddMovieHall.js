    ...
    render(){
        ...
        return(
            <div className="tab-pane fade in show active" id="profile" role="tabpanel">
                <div className="row">
                    <div className="panel-profile">
                        <div className="panel-group-profile">
                            <div className="panel-group-head-profile">Add/Modify Hall Admin Info
                            </div>
                            <hr/>
                ...
                Phone No : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="phoneNumber" onChange={(e) => {this.setState({phoneNumber:e.target.value})}} required/><br/>
                ...
                Ticket Price : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" onChange={(e) => {this.setState({tPrice:e.target.value})}} required/><br/>
                                <br/><Button bsStyle="success" bsSize="sm" onClick={this.add.bind(this)}>Add Hall</Button><br/>
				<br/>
                <hr/>
