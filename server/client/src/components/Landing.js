...
class Landing extends React.Component {
  ...
  renderMoviesNowPlaying() {
    ...
    renderMoviesNowPlayingTest(movies){
        return(
        <div id="myCarousel" className="carousel slide" data-ride="carousel">
            ...
            <div className="carousel-inner">
                    ...
                    {movies.map((movie,i) =>
                        <div className={'item' + movie.activeState}>
                        <img
                            src={movie.url}
                            alt="some movie"
                        />
  ...
  render() {
    ...
    var movies = [];
    movies.push({"url":"http://www.etimesnow.com/wp-content/uploads/2016/04/deadpool-2.jpg","activeState":"active"});
    movies.push({"url":"https://revengeofthefans.com/wp-content/uploads/2018/03/Avengers-Infinity-War-poster.jpg","activeState":"active"});
    movies.push({"url":"https://boygeniusreport.files.wordpress.com/2017/12/guardians-of-the-galaxy-vol-2.jpg?quality=98&strip=all&w=1564","activeState":""});
