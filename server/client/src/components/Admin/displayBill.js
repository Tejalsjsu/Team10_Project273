            ...
            <div className="row">
              <div className="purchaseInfo">
                  <div className="movieInfo">
                      <h3 className="movieTitle">{this.props.admin.billDetails.title}</h3>
                        <span className="movieRating">(NR)</span>
                        <br/><br/><br/>
                        <p className="showDate"><Moment date={this.props.admin.billDetails.date}/></p>
                        ...
                        <p className="username">Name: {this.props.admin.billDetails.firstName} {this.props.admin.billDetails.lastName}</p>
                        <p className="numOfPeople">1 x Adult: ${this.props.admin.billDetails.totalAmount}</p>
                  </div>
              </div>
              <hr/>
              <div className="theaterInfo">
                  <h2 className="theaterName">{this.props.admin.billDetails.hallName}</h2>
                  <div className="address">
                      <p className="theaterMap">
                        {this.props.admin.billDetails.city}, CA
                        <br/>
                        {this.props.admin.billDetails.zipcode}
                      </p>
                  </div>
              </div>
            </div>
